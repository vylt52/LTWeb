...
function validateRegisterForm() {
    ...
    var nameRegex = /^[\p{L}'][\p{L}'\s-]{0,}$/u;

    var email = document.getElementsByName("email")[0].value;
    var phone = document.getElementsByName("phone")[0].value;
    var fullname = document.getElementsByName("fullname")[0].value;
    var password = document.getElementsByName("pass")[0].value;
    var passConfirm = document.getElementsByName("pass-cofirm")[0].value;
...
function validateNewPassword() {
    var password = document.getElementsByName("pass")[0].value;
    var passConfirm = document.getElementsByName("passConfirm")[0].value;
...
function validateChangePass() {
    ...
    var confirmPass = document.getElementsByName("cofirmPass")[0].value;
    ...
    if (oldPass != password) {
        showSwalAlert('error', 'Mật khẩu cũ không khớp !');
        return false;
    }
    if (password == newPass) {
        showSwalAlert('error', 'Mật khẩu cũ không được trùng với mật khẩu mới !');
        return false;
    }
